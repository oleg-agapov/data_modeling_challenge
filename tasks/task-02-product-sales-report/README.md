...
Add a `sell_through_rate` column defined as `units_sold / NULLIF(products.stock + units_sold, 0)` — a rough estimate of how much of the available supply has been sold. Discuss any assumptions this metric requires.
